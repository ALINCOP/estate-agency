...
<div class="container">    
  <div class="row">
      ...
      <div class="panel-heading">Terenuri</div>
  ...
  <table class="table">
    ...
    <tbody>
      ...
      if ($action == "delete") {
                        //delete record
                        $query = "DELETE from terenuri where id_teren=".$id_teren; // sterge automat si pozele- cascade
                        ...
                        if (!$result) {
                            ...
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='modifica_terenuri.php'\" >";
      ...
      if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                                ...
                                echo "<td>  <a href='modifica_terenuri.php?id_teren=".$row['id_teren']."&action=delete'><img src='images/delete.png' alt='delete icon' width='30px'></a></td>";
                                echo "<td><a href='mod_teren.php?id_teren=" . $row['id_teren'] . " '><img src='images/edit.png' alt='edit icon' width='30px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='8'>Nu aveti Terenuri</td></tr>";
                                    }
