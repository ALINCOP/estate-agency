...
/// view
                require("mysql.php");
                $query_terenuri = "select * from v_case_inchiriere;" ;
  ...
  <div class="row">
    ...
    if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                              ...
                              echo "<div class='panel-heading'><b><a href='case_inchiriere.php?id_casa=".$row['id_casa']."&action=view'>". $row["titlu"] ."</a></b></div>";
                              ...
                              echo "</div>";
                                ...
                                echo "<tr><td colspan='8'>Nu exista case de inchiriat!</td></tr>";
                                    }
                                    }
  ?>
