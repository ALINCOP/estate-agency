...
/// view
                require("mysql.php");
                $query_terenuri = "select * from v_terenuri_inchiriere;" ;
  ...
  <div class="row">
    ...
    if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                              ...
                              echo "<div class='panel-heading'><b><a href='terenuri_vanzare.php?id_teren=".$row['id_teren']."&action=view'>". $row["titlu"] ."</a></b></div>";
                              ...
                              echo "</div>";
                                ...
                                echo "<tr><td colspan='8'>Nu exista terenuri de inchiriat!</td></tr>";
                                    }
                                    }
  ?>
