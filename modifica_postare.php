...
<div class="row">
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li class="active-admin"><a href="modifica_postare.php">Modifica postare</a></li>
...
<div class="container">    
  <div class="row">
      ...
      <div class="panel-heading">Postari</div>
  ...
  <table class="table">
    ...
    <tbody>
      <?php
      $action = "view";
       if (isset($_GET['id_postare'])) {
                            $id_postare = $_GET['id_postare'];
      ...
      if ($action == "delete") {
                        //delete record
                        $query = "DELETE from postari where id_postare=".$id_postare;
                        ...
                        if (!$result) {
                            ...
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='modifica_postare.php'\" >";
      ...
      if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                                echo "<tr>";
                                echo "<td>" . $row["id_postare"] . "</td>";
                                echo "<td>" . $row["titlu_postare"] . "</td>";
                                //echo "<td>" . $row["prenume"] . "</td>";
                                //echo "<td>" . $row["mesaj"] . "</td>";
                                //echo "<td> <a href='mailto:'". $row["email"] .">". $row["email"] ."</a> </td>";
                                echo "<td>  <a href='modifica_postare.php?id_postare=".$row['id_postare']."&action=delete'><img src='images/delete.png' alt='delete icon' width='30px'></a></td>";
