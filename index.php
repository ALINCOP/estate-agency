...
<?php
	require("mysql.php");
        $query_apartamente = "SELECT * FROM v_apartamente_lista_imagine";
  	 ...
  	 if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                              ...
                              //echo "<div class='panel-body'><img src=". $row["imagine"] ." /></div>";  style='max-height: 450px; '
      ...
      require("mysql.php");
        $query_case = "SELECT * FROM v_case_lista_imagine";
      ...
      require("mysql.php");
        $query_terenuri = "SELECT * FROM v_terenuri_lista_imagine";
