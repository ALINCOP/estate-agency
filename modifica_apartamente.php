...
<div class="container">    
  <div class="row">
      ...
      <div class="panel-heading">Apartamente</div>
  ...
  <table class="table">
    ...
    <tbody>
      ...
      if ($action == "delete") {
                        //delete record
                        $query = "DELETE from apartamente where id_apartament=".$id_apartament; // sterge automat si pozele- cascade
                        ...
                        if (!$result) {
                            ...
                            echo "<meta http-equiv=\"refresh\" content=\"2; URL='modifica_apartamente.php'\" >";
      ...
      if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                                echo "<tr>";
                                echo "<td>" . $row["id_apartament"] . "</td>";
                                echo "<td>" . $row["titlu"] . "</td>";
                                echo "<td>" . $row["tip_contract"] . "</td>";
                                echo "<td>" . $row["pret"] . " <span class='glyphicon glyphicon-euro'></span></td>";
                                echo "<td>" . $row["localitate"] . "</td>";
                                //echo "<td> <a href='mailto:'". $row["email"] .">". $row["email"] ."</a> </td>";
                                echo "<td>  <a href='modifica_apartamente.php?id_apartament=".$row['id_apartament']."&action=delete'><img src='images/delete.png' alt='delete icon' width='30px'></a></td>";
                                echo "<td><a href='mod_apartament.php?id_apartament=" . $row['id_apartament'] . " '><img src='images/edit.png' alt='edit icon' width='30px'></a></td>";
                                echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='8'>Nu aveti apartamente</td></tr>";
                                    }
