  ...
  <div class="row">
      ...
      <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (!$result) {
                              ...
                              echo "<h2>Modificare efectuată cu success!</h2>";
                                echo "<p>Înapoi la <a href='modifica_terenuri.php'>Lista de terenuri</a>";
                            }
                        } else {
                            //dacă nu s-a efectuat trimiterea, înseamnă că trebuie să afișăm formularul
                            $query = "SELECT *
                                FROM terenuri
                                WHERE terenuri.id_teren=".$id_teren;
                            ...
                            <form id="editTeren" action="mod_teren.php?id_teren=<?=$id_teren?>" method="post">
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6 form-group">
                                        <label >
                                          Pret:</label>
                                            <input type="number" class="form-control" id="pret" name="pret" required="" value="<?=$row["pret"]?>">
                                  </div>
                                      <div class="col-sm-6 form-group">
                    ...
                    <button type="submit" class="btn btn-lg btn-default pull-right" id="submit" value="Submit" name="submit">MODIFICA</button>
                        ...
                        echo "<p>Mergeți înapoi la <a href='modifica_terenuri.php'>Lista de terenuri</a> și selectați unul</p>";
                    }
