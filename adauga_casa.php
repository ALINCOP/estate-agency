  ...
  <div class="row">
        ...
        <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query = "INSERT INTO case_vile (titlu,camere,pret_casa,localitate,an_constructie,id_agent,suprafata,info,garaj,piscina,tip_contract)
                                VALUES ('$titlu', '$camere','$pret_casa','$localitate','$an_constructie' ,'$id_agent' , '$suprafata' , '$info' , '$garaj', '$piscina', '$tip_contract');";
                            ...
                            if (!$result) {
                              ...
                              // "SELECT admin FROM useri where id_user=".$_SESSION['id_user'];
                                $query1 = "SELECT id_casa FROM case_vile ORDER BY id_casa DESC LIMIT 1;";
                                ...
                                if (!empty($file))
                                  {
                                    $query = "INSERT INTO imagini (locatie_imagine,id_casa)
                                  VALUES ('$target_file', '$id_casa');";
                                  $result=mysqli_query($conexiune, $query);
                                }
                                if (!empty($file2))
                                  {
                                    $query = "INSERT INTO imagini (locatie_imagine,id_casa)
                                  VALUES ('$target_file2', '$id_casa');";
                                  $result=mysqli_query($conexiune, $query);
                                }
                                if (!empty($file3))
                                  {
                                    $query = "INSERT INTO imagini (locatie_imagine,id_casa)
                                  VALUES ('$target_file3', '$id_casa');";
                                  $result=mysqli_query($conexiune, $query);
                                }
      ...
      <div class="panel-body">
        <form role="form" id="formular_contact" action="adauga_casa.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">             <div class="col-sm-6 form-group">
       ...
       <div class="row">             <div class="col-sm-6 form-group">
                    <label for="tip_teren">Camere:</label>
                      <input type="text" class="form-control" id="camere" name="camere" required="" placeholder="Camere">
                </div>
               <div class="col-sm-6 form-group">
                    <label >
      ...
      <div class="row">            <div class="col-sm-6 form-group">
                ...
                <div class="col-sm-6 form-group">
                    <label for="tip_teren">Garaj:</label>
                      <select class="form-control" id="garaj" name="garaj">
                            <option>0</option>
                            <option>1</option>
                      </select>
                </div></div>
      <div class="row">            
              ...
              <label for="tip_teren">Tipul contractului:</label>
               ...
               <div class="col-sm-6 form-group">
                <label for="tip_teren">Piscina:</label>
