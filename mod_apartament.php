  ...
  <div class="row">
      ...
      <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (!$result) {
                              ...
                              echo "<h2>Modificare efectuată cu success!</h2>";
                                echo "<p>Înapoi la <a href='modifica_apartamente.php'>Lista de apartamente</a>";
                            }
                        } else {
                            //dacă nu s-a efectuat trimiterea, înseamnă că trebuie să afișăm formularul
                            $query = "SELECT *
                                FROM apartamente
                                WHERE apartamente.id_apartament=".$id_apartament;
                            ...
                            <form id="editApartament" action="mod_apartament.php?id_apartament=<?=$id_apartament?>" method="post">
                    ...
                    <button type="submit" class="btn btn-lg btn-default pull-right" id="submit" value="Submit" name="submit">MODIFICA</button>
                        ...
                        echo "<p>Mergeți înapoi la <a href='modifica_apartamente.php'>Lista de apartamente</a> și selectați unul</p>";
                    }
