...
<div class="container">    
  ...
  <div class="row">
        ...
        <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $query = "INSERT INTO terenuri (titlu,pret,localitate,id_agent,suprafata,tip_teren,info,tip_contract)
                                VALUES ('$titlu', '$pret','$localitate','$id_agent' , '$suprafata' , '$tip_teren' , '$info', '$tip_contract');";
                            ...
                            if (!$result) {
                              ...
                              // "SELECT admin FROM useri where id_user=".$_SESSION['id_user'];
                                $query1 = "SELECT id_teren FROM terenuri ORDER BY id_teren DESC LIMIT 1;";
                                 ...
                                 while($row = mysqli_fetch_array($result2))                               
                                                                
                                  {
                                    //echo "<script language='javascript'>console.info('aici')</script>";
                                          ...
                                          $id_teren=$row["id_teren"];
                                          //echo $id_teren;
                                }

                                if (!empty($file))
                                  {
                                    $query = "INSERT INTO imagini (locatie_imagine,id_teren)
                                  VALUES ('$target_file', '$id_teren');";
                                  $result=mysqli_query($conexiune, $query);
                                }
                                if (!empty($file2))
                                  {
                                    $query = "INSERT INTO imagini (locatie_imagine,id_teren)
                                  VALUES ('$target_file2', '$id_teren');";
                                  $result=mysqli_query($conexiune, $query);
                                }
      ...
      <div class="panel-body">
        <form role="form" id="formular_contact" action="adauga_teren.php" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
    ...
    <div class="row">             <div class="col-sm-6 form-group">
      ...
      <div class="row">            <div class="col-sm-6 form-group">
                    <label for="tip_teren">Tipul terenului:</label>
                      <select class="form-control" id="tip_teren" name="tip_teren">
