...
/// view
                require("mysql.php");
                $query_terenuri = "select * from v_apartamente_vanzare;" ;
  ...
  <div class="row">
    ...
    if (mysqli_num_rows($rezultat) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($rezultat)) {
                              ...
                              echo "<div class='panel-heading'><b><a href='apartamente_vanzare.php?id_apartament=".$row['id_apartament']."&action=view'>". $row["titlu"] ."</a></b></div>";
                              ...
                              echo "</div>";
                                ...
                                echo "<tr><td colspan='8'>Nu exista apartamente de vanzare!</td></tr>";
                                    }
                                    }
  ?>
